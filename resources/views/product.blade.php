...
<body>
<div id="loader" class="fixed inset-0 flex items-center justify-center bg-RED-900">
...
<div class="bg-white" >
  <div x-data="{ open1: false }"  >
    ...
    -->
    <div  x-show="open1" class="relative z-40 lg:hidden" role="dialog" aria-modal="true">
      <!--
      ...
      <div class="fixed inset-0 z-40 flex">
        <!--
          ...
          Leaving: "transition ease-in-out duration-300 transform"
            ...
            To: "translate-x-full"
        -->
        <div   class="relative pt-20 ml-auto flex size-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
          <div class="flex items-center justify-between px-4">
            <h2 class="text-lg font-medium text-gray-900">Filters</h2>
            <button type="button" x-on:click="open1 = ! open1" class="-mr-2 flex size-10 items-center justify-center rounded-md bg-white p-2 text-gray-400">
      ...
      <div class="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-4">
        ...
        <div class="flex items-center" x-data="{ open: false }">
          <div class="relative inline-block text-left">
            <div>
              <button type="button" x-on:click="open = ! open" class="group inline-flex justify-center text-sm font-medium text-gray-700 hover:text-gray-900" id="menu-button" aria-expanded="false" aria-haspopup="true">
                Sort
            ...
            -->
            <div x-show="open" class="absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-white shadow-2xl ring-1 ring-black/5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
          ...
          <button type="button"  x-on:click="open1 = ! open1" class="-m-2 ml-4 p-2 text-gray-400 hover:text-gray-500 sm:ml-6 lg:hidden">
    ...
    @foreach($products as $product)
        <div class="product-card bg-white rounded-lg shadow-md border border-gray-200 p-4">
            <div class="flex flex-col items-center">
                <!-- Product Image -->
                <div class="h-48 w-48 mb-4 bg-gray-100 rounded-lg border flex items-center justify-center overflow-hidden">
